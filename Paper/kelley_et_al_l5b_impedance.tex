...
biophysically detailed model available from the Allen Brain Atlas Data Portal (https://portal.brain-map.org/) \citep{Reimann2013-mg, Shai2015-ff, Markram2015-zg}.
...
is based on data from primary motor cortex (M1) of C57Bl/6J mice, P21.  The model was fit based on perisomatic spiking activity and
...
the I$_h$ conductance plateaus at 0.006 S/cm$^2$ \citep{Harnett2015-s}.  The second mouse model \citep{Reimann2013-mg, Shai2015-ff, Markram2015-zg}
is based on data from primary visual cortex (V1) of C57BL/6 mice, P35-62. It is based largely on a previous model also 
studied here \citep{Hay2011-if}.  The major modification to the original is that Ih conductance is constant in the dendritic tree.
This modification accounted for differences between dendritic sag, dendritic resting membrane potential relative 
to the soma, and dendritic input resistance compared to what is seen in rat L5 somatosensory cortex \citep{Shai2015-ff}.  I$_h$ conductance
in the denrites is 3.7x10$^{-6}$ S/cm$^2$.
