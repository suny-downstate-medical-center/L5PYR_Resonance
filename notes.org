...
* [2020-10-30 Fri] - still working on synaptic stuff 
** no ih, no lk 
from scipy.io import loadmat 
from matplotlib import pyplot as plt 
plt.ion() 
...
data = loadmat('m1pt_apic1305_syn_traces_v2.mat')
# data_zd = loadmat('m1pt_apic1305_zd_syn.mat')
data_zd = loadmat('detailed_noih_syn_v2.mat')
data_lk = loadmat('detailed_nolk_syn_v2.mat')
...
plt.subplot(1,3,1)
plt.plot(data['Freq'][0], data['ZcAmp'][0], color='k', linestyle='-', label='L = 10 kH')
plt.subplot(1,3,2)
plt.plot(data['Freq'][0], data['ZcPhase'][0], color='k', linestyle='-')

data = loadmat('data/toy_withoutL.mat')
plt.subplot(1,3,1)
plt.plot(data['Freq'][0], data['ZcAmp'][0], color='k', linestyle='--', label='L = 1 mH')
plt.subplot(1,3,2)
plt.plot(data['Freq'][0], data['ZcPhase'][0], color='k', linestyle='--')
