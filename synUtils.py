...
def conditionAndTest(stim_seg, soma_seg, Sc0, St0, dSt, start, lag, synType='AMPA'):
    ...
    if synType == 'AMPA':
        ...
        test_i, testCon, testSyn, testStim = createAMPAsyn(stim_seg, start, St0)
    else:
        cond_i, condCon, condSyn, condStim = createNMDAsyn(stim_seg, start, Sc0)
        test_i, testCon, testSyn, testStim = createNMDAsyn(stim_seg, start, St0)
