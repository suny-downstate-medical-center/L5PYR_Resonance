...
import numpy as np 
path_name = 'L5PYR_Resonance/timeDomainOutput/HayApic14/'
...
ZinResAmp = [data1['ZinResAmp'][0][0], data2['ZinResAmp'][0][1], data3['ZinResAmp'][0][1], data3['ZinResAmp'][0][-3]]
ZinResFreq = [data1['ZinResFreq'][0][0], data2['ZinResFreq'][0][1], data3['ZinResFreq'][0][1], data3['ZinResFreq'][0][-3]]
ZinQ = [data1['QfactorIn'][0][0], data2['QfactorIn'][0][1], data3['QfactorIn'][0][1], data3['QfactorIn'][0][-3]]
ZcResAmp = [data1['ZcResAmp'][0][0], data2['ZcResAmp'][0][1], data3['ZcResAmp'][0][1], data3['ZcResAmp'][0][-3]]
ZcResFreq = [data1['ZcResFreq'][0][0], data2['ZcResFreq'][0][1], data3['ZcResFreq'][0][1], data3['ZcResFreq'][0][-3]]
ZcQ = [data1['QfactorTrans'][0][0], data2['QfactorTrans'][0][1], data3['QfactorTrans'][0][1], data3['QfactorTrans'][0][-3]]
dist = [data1['dist'][0][0], data2['dist'][0][1], data3['dist'][0][1], data3['dist'][0][-3]]
plt.figure()
plt.subplot(2,3,1)
...
plt.ylabel('Q-factor')
plt.subplot(2,3,4)
plt.plot(dist, ZcResAmp, '*-')
plt.ylabel('Resonance Amplitude')
plt.subplot(2,3,5)
plt.plot(dist, ZcResFreq, '*-')
plt.ylabel('Transfer Frequency')
plt.title('Transfer Impedance (syn->soma)')
